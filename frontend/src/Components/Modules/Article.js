...
const Article = ({ id, url, img, auth, date, title, desc, favorited, onAddToFavorites, type }) => {
    ...
    return (
        ...
        >
            ...
            {type !== "create post" && (<div className="absolute bottom-0 left-0 right-0 flex justify-center p-2">
