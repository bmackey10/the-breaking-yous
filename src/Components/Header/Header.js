      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="lg:grid lg:grid-cols-3 lg:w-full">
          <div className="hidden lg:flex lg:col-span-1 lg:gap-x-12">
              <Link to="/for-you" className="-m-1.5 p-1.5 text-sm font-semibold leading-6 text-theme-navy-blue">
                  For You
              </Link>
              <Link to="/community" className="-m-1.5 p-1.5 text-sm font-semibold leading-6 text-theme-navy-blue">
                  Community
              </Link>
          </div>
          <div className="flex lg:cols-span-1 justify-center">
              <Link to="/" className="text-sm font-semibold leading-6 text-theme-navy-blue">
                  The Breaking Yous
              </Link>
          </div>
          <div className="hidden lg:flex lg:cols-span-1 lg:justify-end">
            <Link to="/log-in" className="text-sm font-semibold leading-6 text-theme-navy-blue">
              Log in
            </Link>
          </div>
        </div>
      ...
      <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-theme-cream-white-default px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            <Link to="/" className="-m-1.5 p-1.5 text-theme-navy-blue">
                The Breaking Yous
            </Link>
            <button
              type="button"
